...
def main(args):
    ...
    print('parameter count: ', str(num_params))

    writer = SummaryWriter(args.log_dir)
    
    ### DATASET
    musdb = get_musdb_folds(args.dataset_dir, version="NONE HQ")
    ...
    for name, param in model.named_parameters():
      name = name[17:]
      if name[0] == 'b' or name[0] == 'd':
        param.requires_grad = False
        ## moshe edit ##
      elif name[0:7] == 'other.u' or name[0:8] == 'vocals.u':
        param.requires_grad = False
        ## moshe edit ##
    num_params_grad_true: int = sum(p.numel() for p in model.parameters() if p.requires_grad)
    print ('Trainable parameters count: ',str(num_params_grad_true))
    #################
    ...
    while state["worse_epochs"] < args.patience:
        ...
        ################
        train_loss_vec = [train_loss_vec, avg_loss]
        ################
        ...
        ################
        val_loss_vec = [val_loss_vec, val_loss]
        ################
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', type=str, default='/content/drive/MyDrive/DL Project - yaniv/Wave-U-Net-Pytorch-master-fine tuning/logs',
                        help='Folder to write logs into')
    parser.add_argument('--dataset_dir', type=str, default="/mnt/windaten/Datasets/MUSDB18HQ",
                        help='Dataset path')
    parser.add_argument('--hdf_dir', type=str, default="/content/drive/MyDrive/DL Project - yaniv/Wave-U-Net-Pytorch-master-fine tuning/hdf",
                        help='Dataset path')
    parser.add_argument('--checkpoint_dir', type=str, default='/content/drive/MyDrive/DL Project - yaniv/Wave-U-Net-Pytorch-master-fine tuning/checkpoints',
